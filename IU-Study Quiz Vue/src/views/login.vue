<template>
  <div class="login-container">
    ...
    <header data-role="Header" class="login-header">
      <div class="login-nav">
        <navigation-leiste rootClassName="rootClassName14"></navigation-leiste>
      </div>
      <div class="login-btn-group"></div>
      ...
      <div data-role="MobileMenu" class="login-mobile-menu">
        <div class="login-nav1">
          ...
          <navigation-leiste rootClassName="rootClassName15"></navigation-leiste>
        </div>
        <div>
    ...
    <login-formular
      rootClassName="login-formular-root-class-name"
    ></login-formular>
...
export default {
  ...
  metaInfo: {
    title: 'Login - IU-Study Quiz',
    meta: [
      {
        property: 'og:title',
        content: 'Login - IU-Study Quiz',
      },
    ],
  },
}
